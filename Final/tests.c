              ...
              int numNotKeys, int numBuckets)
{
	...
	//REMOVE
	printf("\nNOW CHECKING CONTAINS AND GET ON VALID KEYS");
	//REMOVE
	...
	//REMOVE
	printf("\nNOW DOING CONTAINS AND GETS ON INVALID KEYS");
	//REMOVE
	...
	//REMOVE
	printf("\nNOW DOING Check that all links are present and have a unique key");
	//REMOVE
	...
	//REMOVE
	printf("\nNOW DOING CONTAINS AND GET ON VALID KEYS");
	//REMOVE
	...
	//REMOVE
	printf("\nNOW DOING CHECK CONTAINS AND GET ON INVALID KEYS");
	//REMOVE
	...
	//REMOVE
	printf("\nNOW DOING CHECK THAT THERE ARE NO LINKS IN THE TABLE");
	//REMOVE
